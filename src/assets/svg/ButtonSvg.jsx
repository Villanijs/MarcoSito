const ButtonSvg = (whit) => (
  <>
    ...
    >
      <path
        fill={whit ? "white" : "none"}
        stroke={whit ? "white" : "url(#btn-left)"} // mentioned in ButtonGradient.jsx
        strokeWidth="2"
    ...
    >
      <path
        fill={whit ? "white" : "none"}
        stroke={whit ? "white" : "url(#btn-right)"} // mentioned in ButtonGradient.jsx
        strokeWidth="2"
